...
//				"VH017614", "VH024097", "VH036436", "VH036969"};
		...
		String[] prompts = {//"COSC120160", "COSC120170", "COSC120274", "COSC120275", "COSC130037", "COSC130066",  
		...
		for(int k=0; k < prompts.length; k++){
			...
			String[] topScoringResponses = dr.readFromFile("/Users/lakshmiramachandran/Documents/pearson-datasets/Colorado/Operational Data/autoregexes/"+prompts[k]+"-topscorers.csv", 1);
...
//			csvWriter.close();
			...
			String writeToFile = "/Users/lakshmiramachandran/Documents/pearson-datasets/Colorado/Operational Data/autoregexes/"+prompts[k]+"-auto-regex.csv";
