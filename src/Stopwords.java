	 ...
	 /** @invisible */
	  public static String[] STOP_WORDS = new String[] {
	   ...
	   "back", "be", "became", "because", "become", "becomes",
	    ...
	    "you", "your", "yours", "yourself", "yourselves", "individual","individually","'s"
	  }; 
	  
	  //tokens containing these words aren't compared with other tokens, because they don't add any meaning
	  public static String[] FREQUENT_WORDS = { "a", "am", "an", "and", "any", "as", 
	  ...
	  public static String[] suffixes = {"able","ible","eded", "ed", "en", "est", "ful", "ic", "ing", "ion", 
